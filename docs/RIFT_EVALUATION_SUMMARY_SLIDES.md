...
The first file-backed q1/q2 rows include gzip/JSON parsing in timing and show
modest region/RSS wins; q2 heap also fails under a `1G` cap. Parser/string
allocation still causes GC in region rows too.
