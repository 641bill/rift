...
| Selected stream/application sweep | NEXMark checked Rift is best/tied-best on q3/q8/q9/q11; generated LogHub q2/q3 checked scoped epoch is `2.46/10.32 s` vs heap `3.63/11.22 s`; generated LogHub top templates checked scoped top-k is `1.39 s` vs heap `2.03 s`; DSPBench real file-backed rows are modest/control evidence. | Current presentation-facing stream sweep; Theodolite q2 is opt-in on the real power trace. |
