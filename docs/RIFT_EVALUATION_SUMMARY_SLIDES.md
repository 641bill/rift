...
| Generated page/window stressor | All-optimizations L1 Common Crawl-shaped q1/q2, 1M x3: optimized checked Rift page-token `9.30/9.76 s`, legacy `10.29/11.06 s`, checked SafeZone-backed `12.88/14.39 s` vs heap `16.67/16.23 s`; focused page-token is `23.059 ms` vs heap `38.352 ms`. | Strong generated stream-object pressure win; not real-input proof. |
