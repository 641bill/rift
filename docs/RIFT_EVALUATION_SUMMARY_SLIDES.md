...
| StreamFlex design reproduction | Clean L1 StreamFlexDesign throughput, 20M x3: checked stream `22.81 s`, checked scoped `24.39 s` vs heap `31.26 s`; L2 pressure-latency: checked scoped fastest and checked stream has `0` misses. | Rift-native stable/transient/capsule design reproduction; not exact Ovm artifact evidence. |
...
| Generated page/window stressor | Clean L1 Common Crawl-shaped q1/q2, 1M x3: checked Rift page-token `10.88/11.49 s`, checked SafeZone-backed `13.29/14.84 s` vs heap `17.49/16.73 s`; focused page-token also cuts RSS from `75.1 MB` to about `47.5 MB`. | Strong generated stream-object pressure win; not real-input proof. |
