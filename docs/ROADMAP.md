...
latency. It is the best current full-month control: checked is about `6.0 s`
slower than heap, while reducing measured GC collection time by about `0.13 s`
and keeping RSS much closer to heap than the pre-cap checked run. It is still a
