...
- Q1 checked rank-refresh churn now has a bounded window-rank arena fix:
  ...
  CPU reduction or adding a richer comparator/hash-key rank API; bounded Q2
...
- Rift already has final DEBS application proof. The bounded-sample top-cache
  ...
  measured speed win yet. Richer comparator/hash-key rank collections, optional
