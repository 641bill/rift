...
- A closeable SafeZone mode now exists for Q1/Q2 data-structure placement. The
  ...
  Full-month SafeZone controls are optional follow-up; checked Q1/Q2 CPU
  attribution is the more useful immediate step.
...
- Rerun 100k and 1M instrumented matrices with medians after each change that
  ...
  1M medians.
- Add checked Q1/Q2 CPU attribution for the remaining process-phase overhead.
