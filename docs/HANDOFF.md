...
`7704265cfafa45c6302296067c9a7a92a3c7921b`
(`Pin checked region negative diagnostics`)
...
`69e0be59`; checked negative diagnostics were pinned at `7704265c`. The
