...
The current handle-backed Dataflow checkpoint has L1 final-clean timing rows
for the promoted `checked-epoch-stream` direct-epoch family. These rows are
recorded as a dirty-checkpoint update until the implementation is committed.
...
until committed.
Child `a6c5ad70a` and the follow-up 10M rerun add the named Wikimedia retained
...
The Spark q3 template/session control row has an L1 RSS/checksum run, but its
...
| Broom retained timestamped dataflow | aggregate/join 1M, 5M, 20M, and 1M active-16 have L1 rows; 20M also has checked scoped backend comparison | L2 rows exist for the same representative rows; 20M also has checked scoped L2 | complete as prior-work-style natural heap vs checked Rift evidence plus best-safe-region comparison |
...
|---|---|---|---|---|---:|---:|---:|---:|---:|---|---|
| Broom retained aggregate 20M | generated Broom/Naiad-style timestamped dataflow | timestamp/epoch region | natural heap baseline | `heap-gc` | 3 measured runs in one final-clean process | `5.27 s` | `5.27 s` | `5.27 s` | `75792384 bytes` | checksum `-6213795708380666256`, output `14180644` | Natural heap/GC retained aggregate baseline |
| Broom retained aggregate 20M | generated Broom/Naiad-style timestamped dataflow | checked timestamp/epoch region | prior-work-style checked region win | `checked-rift` | 3 measured runs in one final-clean process | `3.59 s` | `3.59 s` | `3.59 s` | `13565952 bytes` | checksum `-6213795708380666256`, output `14180644` | Checked Rift is about `31.9%` faster and `82%` lower RSS |
| Broom retained aggregate 20M | generated Broom/Naiad-style timestamped dataflow | checked scoped timestamp/epoch region | best safe backend comparison | `checked-region-scoped` | 3 measured runs in one final-clean process | `4.55 s` | `4.55 s` | `4.55 s` | `13729792 bytes` | checksum `-6213795708380666256`, output `14180644` | Checked scoped backend is faster than heap with comparable RSS to checked Rift, but slower than checked Rift on aggregate |
| Broom retained join 20M | generated Broom/Naiad-style timestamped dataflow | timestamp/epoch region | natural heap baseline | `heap-gc` | 3 measured runs in one final-clean process | `5.00 s` | `5.00 s` | `5.00 s` | `74661888 bytes` | checksum `2961953091326998353`, output `13612832` | Natural heap/GC retained join baseline |
| Broom retained join 20M | generated Broom/Naiad-style timestamped dataflow | checked timestamp/epoch region | prior-work-style checked region win | `checked-rift` | 3 measured runs in one final-clean process | `4.26 s` | `4.26 s` | `4.26 s` | `12812288 bytes` | checksum `2961953091326998353`, output `13612832` | Checked Rift is about `14.8%` faster and `83%` lower RSS |
| Broom retained join 20M | generated Broom/Naiad-style timestamped dataflow | checked scoped timestamp/epoch region | best safe backend comparison | `checked-region-scoped` | 3 measured runs in one final-clean process | `4.52 s` | `4.52 s` | `4.52 s` | `12992512 bytes` | checksum `2961953091326998353`, output `13612832` | Checked scoped backend is faster than heap with comparable RSS to checked Rift |
...
| Broom q17 DBGEN SF1 | standardized generated TPC-H DBGEN input | timestamp/epoch region | natural heap baseline | `heap-gc` | 3 measured runs in one final-clean process | `55.44 s` | `55.44 s` | `55.44 s` | `433291264 bytes` | checksum `2919462578996881752`, output `37` | Natural heap/GC retained Q17 baseline over DBGEN SF1 |
| Broom q17 DBGEN SF1 | standardized generated TPC-H DBGEN input | checked timestamp/epoch region | prior-work-style checked region win | `checked-rift` | 3 measured runs in one final-clean process | `51.47 s` | `51.47 s` | `51.47 s` | `48676864 bytes` | checksum `2919462578996881752`, output `37` | Checked Rift is about `7.2%` faster and about `88.8%` lower RSS; heap fails at `128M` while this row completes around `49 MB` |
| Broom q17 DBGEN SF1 | standardized generated TPC-H DBGEN input | checked scoped timestamp/epoch region | best safe backend comparison | `checked-region-scoped` | 3 measured runs in one final-clean process | `53.35 s` | `53.35 s` | `53.35 s` | `48889856 bytes` | checksum `2919462578996881752`, output `37` | Checked scoped is about `3.8%` faster than heap and about `88.7%` lower RSS |
...
| Dataflow SELECT 1M x20 | generated methodology | direct epoch / scoped region | framework API win | `gc-heap` | 3 processes x 20 iterations | `0.61 s` total (`30.5 ms/iter`) | `0.61 s` | `0.62 s` | `39288832 bytes` | checksum `131080080920` | L1 natural heap baseline |
| Dataflow SELECT 1M x20 | generated methodology | direct epoch / scoped region | safe rooted baseline | `region-scoped-rooted` | 3 processes x 20 iterations | `0.44 s` total (`22.0 ms/iter`) | `0.42 s` | `0.45 s` | `7569408 bytes` | checksum `131080080920` | L1 rooted scoped-region baseline |
| Dataflow SELECT 1M x20 | generated methodology | `RiftRegion.epoch` checked scoped | framework API win | `checked-epoch-scoped` | 3 processes x 20 iterations | `0.35 s` total (`17.5 ms/iter`) | `0.34 s` | `0.35 s` | `7569408 bytes` | checksum `131080080920` | L1 checked scoped epoch win over heap and rooted scoped baseline |
| Dataflow SELECT 1M x20 | generated methodology | `RiftRegion.epoch` checked stream | framework API win | `checked-epoch-stream` | 3 processes x 20 iterations | `0.31 s` total (`15.5 ms/iter`) | `0.31 s` | `0.31 s` | `7503872 bytes` | checksum `131080080920` | L1 dirty-checkpoint promoted handle-backed checked stream win |
| Dataflow AGGREGATE 1M x20 | generated methodology | direct epoch / scoped region | framework API win | `gc-heap` | 3 processes x 20 iterations | `1.18 s` total (`59.0 ms/iter`) | `1.18 s` | `1.19 s` | `40091648 bytes` | checksum `163835709480` | L1 natural heap baseline |
| Dataflow AGGREGATE 1M x20 | generated methodology | direct epoch / scoped region | safe rooted baseline | `region-scoped-rooted` | 3 processes x 20 iterations | `0.78 s` total (`39.0 ms/iter`) | `0.78 s` | `0.78 s` | `10862592 bytes` | checksum `163835709480` | L1 rooted scoped-region baseline |
| Dataflow AGGREGATE 1M x20 | generated methodology | `RiftRegion.epoch` checked scoped | framework API win | `checked-epoch-scoped` | 3 processes x 20 iterations | `0.65 s` total (`32.5 ms/iter`) | `0.65 s` | `0.65 s` | `10862592 bytes` | checksum `163835709480` | L1 checked scoped epoch win over heap and rooted scoped baseline |
| Dataflow AGGREGATE 1M x20 | generated methodology | `RiftRegion.epoch` checked stream | framework API win | `checked-epoch-stream` | 3 processes x 20 iterations | `0.61 s` total (`30.5 ms/iter`) | `0.60 s` | `0.61 s` | `10813440 bytes` | checksum `163835709480` | L1 dirty-checkpoint promoted handle-backed checked stream win |
| Dataflow JOIN 1M x20 | generated methodology | direct epoch / scoped region | framework API win | `gc-heap` | 3 processes x 20 iterations | `0.56 s` total (`28.0 ms/iter`) | `0.55 s` | `0.56 s` | `75071488 bytes` | checksum `193232836790` | L1 natural heap baseline |
| Dataflow JOIN 1M x20 | generated methodology | direct epoch / scoped region | safe rooted baseline | `region-scoped-rooted` | 3 processes x 20 iterations | `0.44 s` total (`22.0 ms/iter`) | `0.44 s` | `0.45 s` | `7421952 bytes` | checksum `193232836790` | L1 rooted scoped-region baseline |
| Dataflow JOIN 1M x20 | generated methodology | `RiftRegion.epoch` checked scoped | framework API win | `checked-epoch-scoped` | 3 processes x 20 iterations | `0.37 s` total (`18.5 ms/iter`) | `0.36 s` | `0.37 s` | `7405568 bytes` | checksum `193232836790` | L1 checked scoped epoch win over heap and rooted scoped baseline |
| Dataflow JOIN 1M x20 | generated methodology | `RiftRegion.epoch` checked stream | framework API win | `checked-epoch-stream` | 3 processes x 20 iterations | `0.31 s` total (`15.5 ms/iter`) | `0.31 s` | `0.31 s` | `7389184 bytes` | checksum `193232836790` | L1 dirty-checkpoint promoted handle-backed checked stream win |
...
| StreamFlex design throughput 20M x3 | generated methodology | stable heap state + transient object epochs + bounded capsule | natural heap baseline | `gc-heap` | 1 process x 3 iterations | `31.26 s` total (`10420 ms/iter`) | `31.26 s` | `31.26 s` | `12402688 bytes` | checksum `5305809911915216923`, output `19999119` | L1 clean heap baseline after open-allocation cleanup |
| StreamFlex design throughput 20M x3 | generated methodology | checked `RiftRegion.epoch` scoped backend + bounded capsule | framework API win | `checked-epoch-scoped` | 1 process x 3 iterations | `24.39 s` total (`8130 ms/iter`) | `24.39 s` | `24.39 s` | `12615680 bytes` | checksum `5305809911915216923`, output `19999119` | L1 checked scoped StreamFlex-design win over heap |
| StreamFlex design throughput 20M x3 | generated methodology | checked `RiftRegion.epoch` streaming backend + bounded capsule | framework API win | `checked-epoch-stream` | 1 process x 3 iterations | `22.81 s` total (`7603 ms/iter`) | `22.81 s` | `22.81 s` | `12566528 bytes` | checksum `5305809911915216923`, output `19999119` | L1 checked stream StreamFlex-design win and fastest checked row in this rerun |
...
| LogHub HDFS q3 streaming-file 1M x3 | real-streaming-input HDFS replay | page/window token | natural heap baseline | `heap-immix` | 1 process x 3 streaming replays | `26.88 s` total (`8960 ms/iter`) | `26.88 s` | `26.88 s` | `861995008 bytes` | checksum `1444622413215935538`, output `81897` | L1 natural heap baseline for richer streaming template/session row; matching L2 heap is `8546.791 ms`, GC `97.322 ms`, max GC `131.533 ms` |
| LogHub HDFS q3 streaming-file 1M x3 | real-streaming-input HDFS replay | scoped page/window token | safe rooted baseline / RSS control | `safezone-improved-32k` | 1 process x 3 streaming replays | `30.17 s` total (`10057 ms/iter`) | `30.17 s` | `30.17 s` | `130220032 bytes` | checksum `1444622413215935538`, output `81897` | L1 rooted scoped row cuts RSS sharply but loses elapsed; matching L2 row is `8567.481 ms`, GC `53.908 ms` |
| LogHub HDFS q3 streaming-file 1M x3 | real-streaming-input HDFS replay | checked scoped page-token | framework API / RSS control | `rift-checked-safezone-page-token` | 1 process x 3 streaming replays | `30.29 s` total (`10097 ms/iter`) | `30.29 s` | `30.29 s` | `130252800 bytes` | checksum `1444622413215935538`, output `81897` | L1 checked page/window row cuts RSS about 85% and lowers L2 GC tails, but is about 12.7% slower than heap; classify as RSS/fixed-memory control, not throughput |
| LogHub Spark q3 1M x3 | real Spark file-backed application subset | page/window token | RSS/control only | `heap-immix` | 1 process x 3 iterations | elapsed not promoted | elapsed not promoted | elapsed not promoted | `408354816 bytes` | checksum `-6394170578402718700`, output `287798` | L1 RSS/checksum row only; `/usr/bin/time -l` elapsed was anomalous for this mode. L2 heap is `7602.328 ms`, GC `140.934 ms`. |
| LogHub Spark q3 1M x3 | real Spark file-backed application subset | checked scoped page-token | RSS/control only | `rift-checked-safezone-page-token` | 1 process x 3 iterations | elapsed not promoted | elapsed not promoted | elapsed not promoted | `56098816 bytes` | checksum `-6394170578402718700`, output `287798` | L1 RSS/checksum row only; L2 checked scoped page-token is `7534.013 ms`, GC `31.147 ms`, so this is a modest/control row rather than headline timing. |
...
| Common Crawl-shaped q1 1M x3 | generated WET-shaped stressor | heap page/token stream | natural heap baseline | `heap-immix` | 1 process x 3 iterations | `17.49 s` total (`5830 ms/iter`) | `17.49 s` | `17.49 s` | `408518656 bytes` | checksum `-3166891223384968696`, output `137000000` | L1 clean generated object-pressure baseline after open-allocation cleanup |
| Common Crawl-shaped q1 1M x3 | generated WET-shaped stressor | checked page-token stream | framework API win | `rift-checked-page-token` | 1 process x 3 iterations | `10.88 s` total (`3627 ms/iter`) | `10.88 s` | `10.88 s` | `63242240 bytes` | checksum `-3166891223384968696`, output `137000000` | L1 clean checked page-token win over heap; generated stressor, not real-input proof |
| Common Crawl-shaped q1 1M x3 | generated WET-shaped stressor | checked scoped page-token | framework API win | `rift-checked-safezone-page-token` | 1 process x 3 iterations | `13.29 s` total (`4430 ms/iter`) | `13.29 s` | `13.29 s` | `63373312 bytes` | checksum `-3166891223384968696`, output `137000000` | L1 clean checked scoped page-token win over heap, slower than checked Rift page-token in this rerun |
| Common Crawl-shaped q2 1M x3 | generated WET-shaped stressor | heap page/window stream | natural heap baseline | `heap-immix` | 1 process x 3 iterations | `16.73 s` total (`5577 ms/iter`) | `16.73 s` | `16.73 s` | `408518656 bytes` | checksum `1076064953308107199`, output `929230` | L1 clean generated object-pressure baseline after open-allocation cleanup |
| Common Crawl-shaped q2 1M x3 | generated WET-shaped stressor | checked page-token stream | framework API win | `rift-checked-page-token` | 1 process x 3 iterations | `11.49 s` total (`3830 ms/iter`) | `11.49 s` | `11.49 s` | `63258624 bytes` | checksum `1076064953308107199`, output `929230` | L1 clean checked page-token win over heap; generated stressor, not real-input proof |
| Common Crawl-shaped q2 1M x3 | generated WET-shaped stressor | checked scoped page-token | framework API win | `rift-checked-safezone-page-token` | 1 process x 3 iterations | `14.84 s` total (`4947 ms/iter`) | `14.84 s` | `14.84 s` | `63340544 bytes` | checksum `1076064953308107199`, output `929230` | L1 clean checked scoped page-token win over heap, slower than checked Rift page-token in this rerun |
