...
The one-run full-file feasibility pass over all `35862259` compressed rows
...
`7122.811 ms`. Treat this as full-input feasibility until repeated; the 10M
x3 row remains the report-grade median.
