...
top-k increment hot-path follow-up at child `59acadda6`. It records which
...
1. **Top-k/template-ranking integration candidate**: `EpochTopKByKey` now
   ...
   overhead to single digits. Use it only with retained controls and natural
   top-k workloads.
