...
| LogHub HDFS q2, Spark/Windows q3, DSPBench Log q2, GH Archive q1/q2 | complete where used; Spark q3 L1 elapsed not promoted because `/usr/bin/time` real field was anomalous | complete | real-input page/window modest/RSS/control rows | keep as real-input modest/control evidence |
