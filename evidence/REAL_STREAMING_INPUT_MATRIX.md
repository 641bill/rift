...
- Named retained clickstream row now promoted and scale-checked to 10M x3:
...
- Configuration: `records=1000000`, 5M scale-up, and 10M 3-run scale-up,
...
10M 3-run report-grade rows:

| Mode | L1 external s | L1 RSS bytes | L2 median ms | Median GC ms | Max GC ms | Region op ms | Checksum | Output |
|---|---:|---:|---:|---:|---:|---:|---:|---:|
| `heap-gc` | `62.52` | `1796128768` | `20103.863` | `851.023` | `885.434` | `0.000` | `8006060730683441349` | `9323019` |
...
- The 5M scale-up keeps L1 checked Rift slightly faster (`27.86 s` versus
  ...
  GC-tail evidence.
- The 10M 3-run row is now report-grade scale-up evidence: checked Rift is
  L1 `59.37 s`, RSS `138 MB`, versus heap `62.52 s`, RSS `1.80 GB`. L2
  checked Rift is `19635.995 ms` with `96.069 ms` GC and `24.329 ms`
